...
// One‑page site for G‑Force Exterior Cleaning — Netlify friendly, no Tailwind required
// Notes:
// • Replace placeholder images and copy with your branding.
// • Klarna badge is visible in hero + footer (non‑clickable for now).
// • Contact form uses mailto; we can switch to Netlify Forms later.
    ...
    <header style={styles.header}>
      <div style={styles.containerRow}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <img
            src="https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=300&auto=format&fit=crop"
            alt="G‑Force Exterior Cleaning Services logo"
            style={{ height: 40, borderRadius: 6 }}
          />
          <div style={{ lineHeight: 1.1 }}>
            <div style={{ fontWeight: 700 }}>G‑Force Exterior Cleaning</div>
            <div style={{ fontSize: 12, color: "#475569" }}>Coral Springs, FL</div>
          </div>
        </div>
        <nav style={{ display: "none", gap: 18 }} className="nav-md">
          <a href="#services" style={styles.navLink}>Services</a>
          <a href="#process" style={styles.navLink}>How it works</a>
          <a href="#gallery" style={styles.navLink}>Results</a>
          <a href="#reviews" style={styles.navLink}>Reviews</a>
          <a href="#faq" style={styles.navLink}>FAQ</a>
          <a href="#contact" style={{ ...styles.button, background: "#0f172a", color: "white" }}>Get a quote</a>
        </nav>
      </div>
    </header>
  );
...
function Hero() {
  return (
    <section style={{ position: "relative", overflow: "hidden" }}>
      <img
        src="https://images.unsplash.com/photo-1572985025310-cc2c6ac71b9d?q=80&w=2000&auto=format&fit=crop"
        alt="Clean home exterior after soft‑wash"
        style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: 0.18 }}
      />
      <div style={{ ...styles.container, padding: "72px 16px", position: "relative" }}>
        <div style={{ maxWidth: 800 }}>
          <h1 style={styles.h1}>
            Restore your curb appeal—
            <span style={{ display: "block" }}>the safe, professional way.</span>
          </h1>
          <p style={styles.lead}>
            G‑Force Exterior Cleaning Services helps South Florida homeowners, HOAs, and property managers keep
            properties looking their best. We work with any budget (especially on long‑term contracts), show up on
            time, keep cancellations to a minimum, and offer financing through Klarna for all projects.
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 8 }}>
            <img src="https://upload.wikimedia.org/wikipedia/commons/0/0f/Klarna_Logo_black.svg" alt="Klarna" style={{ height: 22 }} />
            <span style={{ fontSize: 12, color: "#64748b" }}>*Subject to approval. Terms from Klarna.</span>
          </div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 20 }}>
            <a href="#contact" style={{ ...styles.button, background: "#0f172a", color: "white" }}>Get a same‑day quote</a>
            <a href="#services" style={{ ...styles.button, border: "1px solid #cbd5e1" }}>See services</a>
          </div>
